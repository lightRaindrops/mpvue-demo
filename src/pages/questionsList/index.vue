        ...
        <div class="mainBox" :style="pageHeight">
            <div class="group">
                <div class="item" v-for="(item,index) in items" :key="index">
                    <a class="m DB" :href="'../problemInfo/main?id=' + item.id">
                        <div class="t fx">
                            <div class="fx1">
                    ...
                    <a :href="'../problemInfo/main?id=' + item.id" class="btn wtjd">
                        为Ta解答
                    </a>
                </div>
...
function loadFunc(data, back) {
    data.pageNumber = 1
    $.post($.url('noAnswerQuestion'), function (res) {
        data.res = res
